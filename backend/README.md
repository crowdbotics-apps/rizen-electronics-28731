...
## Project Structure
    ...
    ├── rizen_electronics_28731  # Django project configurations
...
1. Clone this repo and `cd rizen_electronics_28731`
...
2. Clone this repo and `cd rizen_electronics_28731`
